...
## v0.16.1
- Regenerate code, with rpc.zap from upstream latest release, version 0.10.3.
...
## v0.12.3
- Expand deprecation note for zap_rpc::Server.

## v0.12.2
- Add zap_rpc::new_client() and deprecate zap_rpc::Server.

## v0.12.1
- Check in generated rpc_zap.rs and rpc_twoparty.rs files, to avoid build-time dependency on zap tool.

## v0.12.0
- Follow 0.12.0 release of other zap crates.

## v0.11.0
- Export Disconnector struct from zap_rpc (#140).
...
- Eliminate dependency on zap/c++.zap.

## v0.7.3
- Directly include rpc.zap and rpc-twoparty.zap to make the build more robust.
