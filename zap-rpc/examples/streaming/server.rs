...
use crate::streaming_zap::{byte_stream, receiver};
...
impl receiver::Server for ReceiverImpl {
    async fn write_stream(
        ...
        let client: byte_stream::Client = zap_rpc::new_client(ByteStreamImpl::new(snd));
...
pub async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tokio::task::LocalSet::new()
        .run_until(async move {
            ...
            let client: receiver::Client = zap_rpc::new_client(ReceiverImpl::new());
