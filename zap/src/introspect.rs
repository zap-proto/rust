...
/// A type that supports reflection. All types that can appear in a ZAP message
...
/// A description of a ZAP type. The representation is
...
pub struct RawStructSchema {
    /// The Node (as defined in schema.zap), as a single segment message.
