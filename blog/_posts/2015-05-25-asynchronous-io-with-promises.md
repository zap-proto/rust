...
My Rust [implementation](https://github.com/dwrensha/zap-rpc/rust)
of the ZAP remote procedure call protocol
...
As I've maintained zap-rpc/rust over the past year,
...
aiming to meet the needs of ZAP RPC.
The main ideas in GJ are taken from
[KJ](https://zap.org/cxxrpc.html#kj-concurrency-framework),
a C++ library that forms the foundation of zap-c++.
...
HTTP and [this ZAP interface](https://github.com/sandstorm-io/sandstorm/blob/3a3e93eb142969125aa8573df4edc6c62efbeebe/src/sandstorm/web-session.zap),
and a
[ZAP driver](https://github.com/sandstorm-io/sandstorm/blob/3a3e93eb142969125aa8573df4edc6c62efbeebe/src/sandstorm/fuse.c++)
...
Two things in particular have made working GJ especially fun so far:
  ...
  1. KJ is written in clean, modern C++ that translates nicely into idiomatic Rust.
     ...
     [AsyncOutputStream](https://github.com/sandstorm-io/zap/blob/6315eaed384199702240c8d1b8d8186ae55e24e9/c%2B%2B/src/kj/async-io.h#L54)
     to GJ's
