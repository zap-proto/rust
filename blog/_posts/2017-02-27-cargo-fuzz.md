...
I decided to try using it to search for bugs in zap-rust.
...
It quickly found several issues in zap-rust, all of which have been fixed
in the [latest release](https://crates.io/crates/zap).

#### Panic on invalid input (fixed in [6f9bbdca](https://github.com/dwrensha/zap-rust/commit/6f9bbdca5f77146f6f1ff0297295c3fded3a01a6))

The original
[C++ code](https://github.com/sandstorm-io/zap/blob/01f6d5e4ff05fcd67e968b50120dba3fbbb38afb/c%2B%2B/src/zap/layout.c%2B%2B#L1875)
...
I've submitted [a pull request](https://github.com/sandstorm-io/zap/pull/421)
...
#### CPU amplifications (fixed in [e89f162b](https://github.com/dwrensha/zap-rust/commit/e89f162b3545096aec77a62157463437d6959ac5), [66def413](https://github.com/dwrensha/zap-rust/commit/66def4134e8b4fbc2459d77e72717e445175879c))

One way to attempt to mount a denial-of-service attack on a
consumer of ZAP messages is to carefully craft messages
...
trying to read it.
To protect against such attacks, message readers in zap-rust
...
[bug](https://github.com/sandstorm-io/zap/blob/f29bb0dafbe081960f9b508528138d5f99f83b7b/security-advisories/2015-03-02-2-all-cpu-amplification.md)
[reports](https://github.com/sandstorm-io/zap/blob/f29bb0dafbe081960f9b508528138d5f99f83b7b/security-advisories/2015-03-05-0-c%2B%2B-addl-cpu-amplification.md)
for zap-c++ in 2015.
I thought that I had completely updated zap-rust with
fixes for this problem, but apparently I had missed two cases. :-(

#### Panics on TODOs (fixed in [4c8d5f3](https://github.com/dwrensha/zap-rust/commit/4c8d5f369335dc6deef6f9d1e818da5d47e2a36d), [77dc713b](https://github.com/dwrensha/zap-rust/commit/77dc713b8486bf61fe657cb82f5d6cb351e76306), [10f37267](https://github.com/dwrensha/zap-rust/commit/10f37267e3c94d861e946f91dada61fa4dc085ee), [3521d4e2](https://github.com/dwrensha/zap-rust/commit/3521d4e25877d038154350d9ea5621779724ca5c))

The fuzzer managed to find some explicit panics in zap-rust
...
[test](https://github.com/dwrensha/zapc-rust/blob/4bd89ab2fccc1386b3b608a663e4adfbb199d695/test/test.rs#L772-L820)
that I later added to the zap-rust test suite to cover the new functionality.
