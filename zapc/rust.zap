# This file contains annotations that are recognized by the zapc-rust code generator.
#
# To use this file, you will need to make sure that it is included in the directories
# searched by `zap compile`. An easy way to do that is to copy it into your project
...
# annotation should follow zap capitalization conventions. So, for example,
...
# "baz.zap", then you could include the generated code like this:
#
#  pub mod foo {
#    pub mod bar {
#      zap::generated_code!(pub mod baz_zap);
#    }
#  }
...
#
# Zap pointer types are nullable. Normally get_field will return the default
