fn main() {
    zapc::CompilerCommand::new()
        ...
        .file("test.zap")
        .file("in-submodule.zap")
        .file("in-other-submodule.zap")
        .file("schema/test-in-dir.zap")
        .file("schema-with-src-prefix/test-in-src-prefix-dir.zap")
    ...
    zapc::CompilerCommand::new()
        .file("test-default-parent-module.zap")
        .file("test-default-parent-module-override.zap")
    ...
    // `zap compile` will create this directory
    output_path.push("inner-output-path");
    zapc::CompilerCommand::new()
        .file("test-output-path.zap")
