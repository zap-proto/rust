## v0.25.0
- Follow v0.25.0 release of other zap crates.

## v0.24.0
- Follow v0.24.0 release of other zap crates.

## v0.23.1
- Fix zap dependency to be zap-v0.23.0 rather than zap-v0.23.0-alpha.

## v0.23.0
- Follow v0.23.0 release of other zap crates.

## v0.22.0
- Follow v0.22.0 release of other zap crates.

## v0.21.0
- Follow v0.21.0 release of other zap crates.
...
- Follow v0.20.0 release of other zap crates.

## v0.19.1
- Fix bug in `write_queue::len()`.

## v0.19.0
- Follow v0.19.0 release of other zap crates.
...
## v0.18.0
- Follow v0.18.0 release of other zap crates.

## v0.17.0
- Follow v0.17.0 release of other zap crates.

## v0.16.0
- Follow v0.16.0 release of other zap crates.
...
## v0.15.0
- Follow v0.15.0 release of other zap crates.
...
## v0.14.0
- Make `read_message()` return an error on EOF, to match the behavior of `zap::serialize::read_message()`.

## v0.13.2
- Rename `read_message()` to `try_read_message()`, for consistency with `zap::serialize::try_read_message()`.
...
## v0.12.0
- Use new zap::serialize::SegmentLengthsBuilder API.
...
## v0.9.0
- No changes -- just a version bump to match the rest of the zap crates.
...
## v0.0.1
- Code pulled in from https://github.com/dwrensha/zap-rust/pull/66.
